...
const Map<String, String> stringsZh = <String, String>{
  ...
  'noNotifications': '暂无通知。用药提醒将显示在这里。',
  'couldNotLoadNotifications': '无法加载通知。{error}',
  ...
  'notificationStatusPending': '现在该用药',
  'notificationExactAlarmHint': '若要准时收到用药提醒，请允许 Aura Guide 的闹钟和提醒权限。',
  'openAlarmSettings': '去设置',
  'pushTokenSaved': '用药提醒已启用（{preview}）。',
  'pushTokenSavedWithTest': '提醒已启用。请在通知栏查看测试通知。',
  'pushTokenTestSent': '已发送测试通知。请查看通知栏。',
  'pushTokenSavedShort': '此设备已启用用药提醒。',
  'pushTokenAlreadySaved': '推送令牌已注册。',
  'pushTokenEnableNotifications': '请先在设置中开启通知。',
  'pushTokenSignInRequired': '请先以患者身份登录以注册提醒。',
  'pushTokenUnavailable': '无法获取推送令牌。请使用带有 Google Play 服务的手机，并再次点击通知按钮。',
  'pushTokenSaveFailed': '无法将推送令牌保存到 Firestore。',
